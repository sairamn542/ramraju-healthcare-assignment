        ...
        <div className="main">
          ...
          <div>
            <div className="icon-card">
              <span className='icons fas fa-user-md'></span>
              <div>Doctor</div>
            </div>
            <div className="icon-card">
              <span className='icons fa-solid fa-flask'></span>
              <div>Lab</div>
            </div>
            <div className="icon-card">
              <span className='icons bi bi-hospital'></span>
              <div>Hospital</div>
            </div>
            <div className="icon-card">
              <span className='icons bi bi-capsule'></span>
              <div>Medical Store</div>
            </div>
            <div className="icon-card">
              <span className="icons fa-solid fa-truck-medical"></span>
              <div>Ambulance</div>
            </div>
          </div>
        </div>
